...
I'm a student and want to search my school website
So that I can get some education.
...
Given I am on the cscc.edu page
When I click the link for csci 2994 from result page to view textbook information
